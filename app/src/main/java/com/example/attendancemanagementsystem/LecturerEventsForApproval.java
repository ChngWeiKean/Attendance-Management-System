...
public class LecturerEventsForApproval extends AppCompatActivity {
    TextView title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.menu_dashboard) {
                    startActivity(new Intent(LecturerEventsForApproval.this, LecturerDashboardActivity.class));
                } else if (menuItem.getItemId() == R.id.menu_events) {
                    startActivity(new Intent(LecturerEventsForApproval.this, LecturerEventActivity.class));
                } else if (menuItem.getItemId() == R.id.menu_user_profile) {
                    startActivity(new Intent(LecturerEventsForApproval.this, LecturerProfileSettingsActivity.class));
                } else if (menuItem.getItemId() == R.id.menu_logout) {
                    // Implement logout
                    // Clear the "Remember Me" preference
                    getSharedPreferences("MyPrefs", MODE_PRIVATE).edit().clear().apply();
                    // Redirect to login page
                    startActivity(new Intent(LecturerEventsForApproval.this, MainActivity.class));
                }
                return true;
            }
        });
        ...
        Button approveButton = findViewById(R.id.approve_event_button);
    ...
    private void setupRecyclerView() {
        ...
        if (!pendingEventList.isEmpty()) {
            ...
            title.setText("Pending For Approval");
            title.setTextColor(ContextCompat.getColor(this, R.color.purple));
            RecyclerView pendingEventRecyclerView = findViewById(R.id.event_cards_container);
            LecturerEventRecyclerAdapter approvedEventAdapter = new LecturerEventRecyclerAdapter(pendingEventList, userId);
            ...
            adapterOnClick(approvedEventAdapter, pendingEventList, pendingEventRecyclerView);
        } else {
            TextView title = findViewById(R.id.title);
    ...
    private void adapterOnClick(LecturerEventRecyclerAdapter adapter, List<Event> eventList, RecyclerView eventRecyclerView) {
        ...
        adapter.setOnItemClickListener(position -> {
            ...
            Intent intent = new Intent(LecturerEventsForApproval.this, LecturerViewAndApproveEventsActivity.class);
