...
public class StudentDashboardActivity extends AppCompatActivity {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.menu_dashboard) {
                    ...
                    startActivity(new Intent(StudentDashboardActivity.this, StudentProfileSettingsActivity.class));
    ...
    private void setupRecyclerView() {
        ...
        adapter.setOnItemClickListener(position -> {
            ...
            Intent intent = new Intent(StudentDashboardActivity.this, StudentCourseDetailsActivity.class);
